          ...
          <form action="#" autocomplete="off" class="space-y-6">
            ...
            <div>
              ...
              <div class="relative rounded-md shadow-md mt-2">
                ...
                <input type="text" id="name" name="name" required class="border-gray-300 pl-7 rounded-md focus:border-green-500 focus:ring-green-500 text-sm w-full" placeholder="John Doe">
              </div>
            </div>
