    ...
    <main class="flex flex-col justify-center pb-20">
        ...
        <div class="bg-white/50 backdrop-blur-xl mt-10 mx-auto rounded-xl shadow-xl p-5 sm:p-10 w-150">
          ...
          >
            ...
            <!--            input Email-->
            <div v-for="(field, i) in formData" :key="i">
              ...
              <div class="relative rounded-md shadow-md mt-2">
                ...
                >
<!--                :class="{-->
<!--                'border-red-500 focus:border-red-500': v$[i].value?.$error,-->
<!--                'border-[#42d392] ': !v$[i].value?.$invalid,-->
<!--                }"-->
...
<script setup>
  ...
  v$.confirmPassword = computed(() => {
    return {
      required: formData[3].value === formData[3].value
      // required: !v$.formData[2].value || v$.formData[2].value === v$.formData[1].value
    }
  })
